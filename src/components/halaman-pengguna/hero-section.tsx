...
const LoggedInHero = () => {
  ...
  return (
    <header className="relative overflow-hidden bg-gradient-to-br from-[#1a3491] to-[#0a3d91] text-white">
      <div
        className="pointer-events-none absolute inset-0 -translate-x-1/3 translate-y-1/4 scale-150 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.18),_transparent_60%)] opacity-80"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto mt-6 max-w-[900px] px-4 pb-12 text-center sm:mt-10 sm:px-6 sm:pb-16">
        <div
          className="pointer-events-none absolute -left-24 top-8 h-40 w-40 rounded-full bg-white/10 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute -right-28 bottom-0 h-56 w-56 rounded-full bg-[#072e6f]/40 blur-3xl"
          aria-hidden="true"
        />
