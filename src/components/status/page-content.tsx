        ...
        <section className="mt-4 sm:mt-6 rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-6 shadow-xl">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-[11px] sm:text-xs text-slate-500">
            <span className="inline-flex items-center gap-1.5">
              <span className="inline-block h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-emerald-500" />{" "}
              Selesai
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="inline-block h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-[#0a3d91]" />{" "}
              Sedang Berjalan
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="inline-block h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-slate-300" />{" "}
              Berikutnya
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="inline-block h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-rose-500" />{" "}
              Ditolak
            </span>
          </div>
          ...
          <div className="mt-6 sm:mt-8">
            <div className="rounded-2xl border border-slate-200 bg-white px-5 py-6 shadow-lg sm:px-6">
              ...
              <p className="mt-2 text-sm text-slate-600 sm:text-base">
                Bantu kami meningkatkan layanan dengan memberikan penilaian pada
                  ...
                  <form className="space-y-6" onSubmit={handleSubmitFeedback}>
                    <DialogHeader>
                      ...
                      <DialogDescription className="text-slate-500">
                        Pilih jumlah bintang dan tulis masukan untuk membantu
                        kami menyempurnakan layanan.
                      </DialogDescription>
                    </DialogHeader>
